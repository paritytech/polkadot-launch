...
export async function registerParachain(api:ApiPromise, id:string, wasm:string, header:string):Promise<void> {
...
export async function setBalance(api:ApiPromise, who:string, value:string):Promise<void> {
  return new Promise<void>(async (resolvePromise, reject) => {
    await cryptoWaitReady();
...
export async function sendHrmpMessage(api:ApiPromise, recipient:string, data:string) {
	await cryptoWaitReady();
